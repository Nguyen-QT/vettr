...
// of intake.schema.ts's DESIGN_TAG_OPTIONS/AESTHETIC_TAG_OPTIONS, typed
...
// re-check of intake.schema.ts's structural rules. Assumes the input has
// already passed clientIntakeInputSchema.
